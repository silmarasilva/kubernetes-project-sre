...
def add_compra():
    try:
        ...
        if _data and _idCliente and _idCurso and request.method == 'POST':
            ...
            cliente = requests.get(f'http//{clientes}/clientes/{_idCliente}', headers = {"Authorization":"Basic c2lsc2lsOjEyMzQ1Njc="})
            curso = requests.get(f'http//{cursos}/cursos/{_idCurso}', headers = {"Authorization":"Basic c2lsc2lsOjEyMzQ1Njc="})
...
def id_compras (idCliente):
    try:
        ...
        cliente = requests.get(f'http//{clientes}/clientes/{idCliente}', headers = {"Authorization":"Basic c2lsc2lsOjEyMzQ1Njc="})
        for i in (userRow):
            #j = i['idCurso']
            ...
            # i["data"] = f"{i['data']}"
            # curso.append(c.json())
            c = requests.get(f'http//{cursos}/cursos/{i["idCurso"]}', headers = {"Authorization":"Basic c2lsc2lsOjEyMzQ1Njc="}, verify=False)
            i["data"] = f"{i['data']}"
            curso.append(c.json())
